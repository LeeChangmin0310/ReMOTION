...
# from ...tools.wavelet_module import LearnableWaveletTransform #### PRV MODE ####
...
class RhythmMamba(nn.Module):
    def __init__(self, 
        ...
        #### PRV MODE ####
        # self.wavelet_transform = LearnableWaveletTransform(levels=4, learnable_params=True)
    ...
    '''
        ...
        prv = [torch.max(coeff[-1]) - torch.min(coeff[-1]) for coeff in wavelet_coeffs]
